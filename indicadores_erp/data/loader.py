...
def load_data():
    ...
    data = {
        ...
        'Sessões': [5218, 5600, 5717, 7654, 8028, 2361, 0, 0],
        'Primeira Visita': [2900, 3562, 3500, 5400, 5548, 1849, 0, 0],
        'Leads': [270, 290, 401, 600, 604, 183, 0, 0],
        'TC Usuários (%)': [9.32, 8.79, 11.46, 11.11, 10.89, 9.90, 0, 0],
        'Clientes Web': [16, 15, 18, 20, 24, 3, 0, 0],
        'TC Leads (%)': [5.93, 5.50, 4.50, 3.33, 3.97, 1.64, 0, 0],
        'Receita Web': [2114.56, 1991.31, 2591.91, 2728.92, 3393.42, 424.20, 0, 0],
        'Ticket Médio': [132.16, 132.75, 149.99, 136.45, 141.40, 141.40, 0, 0],
        'Custo Meta': [2238.52, 2328.16, 2731.39, 3476.39, 3807.17, 987.33, 0, 0],
        'Custo Google': [2934.49, 3083.29, 3194.67, 4932.45, 6127.84, 1623.42, 0, 0],
        'Total Ads': [5173.01, 5411.32, 5926.06, 8408.84, 9935.01, 2610.75, 0, 0],
        'CAC': [323.31, 360.75, 329.23, 420.44, 413.96, 870.25, 0, 0],
