...
def load_data():
    ...
    data = {
        ...
        'Leads': [270, 290, 401, 600, 604, 536, 0, 0],
        'TC Usuários (%)': [9.32, 8.79, 11.46, 11.11, 10.89, 9.01, 0, 0],
        'Clientes Web': [16, 15, 18, 20, 24, 8, 0, 0],
        'TC Leads (%)': [5.93, 5.50, 4.50, 3.33, 3.97, 1.93, 0, 0],
        'Receita Web': [2114.56, 1991.31, 2591.91, 2728.92, 3393.42, 1164.74, 0, 0],
        ...
        'CAC:LTV': [4.9, 4.4, 5.5, 3.9, 4.1, 1.4, 0, 0],
